        ...
        <CCard>
          ...
          >
            <h4 class="card-title mb-0 text-white">
              <CIcon name="cil-window-restore" size="xl" /> งานซ่อม หน่วยงาน: ไฟฟ้า
            </h4>
          </CCardHeader>
            ...
            <div class="custom-tabs">
              ...
              <div class="tabs-content">
                <div v-show="activeTab === 'report'" class="tab-panel">
                  <Treportable @show-detail="handleShowDetail" />
                </div>
                <div v-show="activeTab === 'history'" class="tab-panel">
                  <Thistorytable @show-detail="handleShowDetail" />
                </div>
              </div>
            </div>
          </CCardBody>
...
<script>
import Thistorytable from "../../components/technician/Thistorytable.vue";
import Treportable from "../../components/technician/Treportable.vue";
