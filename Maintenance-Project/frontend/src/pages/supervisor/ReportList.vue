            ...
            <div class="custom-tabs">
              ...
              <div class="tabs-content">
                <div v-show="activeTab === 'report'" class="tab-panel">
                  <Sreportable @show-detail="handleShowDetail" />
                </div>
                <div v-show="activeTab === 'history'" class="tab-panel">
                  <Shistorytable @show-detail="handleShowDetail" />
                </div>
              </div>
            </div>
          </CCardBody>
...
<script>
import Shistorytable from "../../components/supervisor/Shistorytable.vue";
import Sreportable from "../../components/supervisor/Sreportable.vue";
