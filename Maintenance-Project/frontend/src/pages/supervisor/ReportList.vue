        ...
        <CCard>
          <CCardHeader style="background-color: #8C1007;" class="border-bottom d-flex justify-content-between align-items-center">
            <h4 class="card-title mb-0 text-white">
              <CIcon name="cil-window-restore" size="xl"/> งานซ่อมแผนกไฟฟ้า
            </h4>
          </CCardHeader>
            ...
            <div class="custom-tabs">
              <div class="tabs-header">
                ...
                >
                  ...
                  <span style="font-size: 15px; font-weight: 500;">รายการแจ้งซ่อมแผนกไฟฟ้าทั้งหมด</span>
                </button>
                <button 
                ...
                >
                  ...
                  <span style="font-size: 15px; font-weight: 500;">ประวัติการแจ้งซ่อมแผนกไฟฟ้าทั้งหมด</span>
                </button>
              </div>
